export function KPICard({ label, value, trend, icon, backgroundColor }) {
  return (
    <div
      className={`${backgroundColor} rounded-xl p-md shadow-[0px_4px_12px_rgba(27,67,50,0.04)] relative overflow-hidden group`}
    >
      <div className="absolute right-0 top-0 w-32 h-32 bg-on-primary-container/10 rounded-full blur-2xl -mr-10 -mt-10 transition-transform group-hover:scale-110"></div>
